...
| 2026-04-08 | Profile page CSS consolidation (redesign branch) — .content/.committee-content/.race-content → .profile-content in styles.css (padding:--space-32, opacity:0 reveal); .candidate-row/.committee-header-row → .profile-header-row (no margin-bottom); .candidate-name/.committee-name-display/.race-title → .page-title only (.profile-header-row .page-title gets min-width:0); .page-header bottom padding --space-16 → --space-32; .candidate-race-label margin-bottom removed; display type clamp 1.6–5rem → 2rem–4.5rem; CLAUDE.md + design-system.html + test-cases.md updated; tests/pages.spec.js + smoke.spec.js updated (2 class → ID selector updates) | styles.css, candidate.html, committee.html, race.html, design-system.html, CLAUDE.md, tests/pages.spec.js, tests/smoke.spec.js (redesign branch only) | None | 341/341 Track 1 passing |
