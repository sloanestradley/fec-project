...
- [ ] Clicking a cycle row navigates to `#year#summary` and loads detail view (verify tabs bar visible after)
- [ ] Browser back from detail view → returns to index view (CareerStrip and cycle index visible again)
