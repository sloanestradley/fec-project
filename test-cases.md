...
**Automated tests (Track 1):** Run `npx playwright test` from the project root before and after changes. 416 structural tests across all pages run in ~2 minutes with mocked API. See `TESTING.md` for full details.
