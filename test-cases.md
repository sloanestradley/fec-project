...
- [ ] **Top Individual Contributors per cycle:** ActBlue on cycle 2024 and cycle 2026 each show their own top donors keyed by cycle (KV hit per cycle); data note includes "Top individual contributors pre-computed from FEC bulk data, refreshed daily." with no "most recent cycle only" disclaimer (the scoping copy was tied to All-time mode, removed in T8).
