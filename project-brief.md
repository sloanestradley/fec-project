...
*Raised*
- Breakdown by contributor type (itemized individuals, unitemized individuals, PACs & other committees, party committees, candidate authorized committees, candidate self-funding, loans, federal funds, offsets, other receipts) — donut chart. **Superseded-in-progress:** the Raised + Spent donuts are being replaced by a single **Money flow (Sankey)** diagram that shows Raised→Committee→Spent in one conserving picture (see Definitions; Sankey build 2026-06-09). The Sankey currently **coexists** with the donuts on the detail view; a later scope toggle will make them mutually exclusive, keeping the donut as the fallback for the gated cases (presidential, dual-account committees).
