...
- **Testing:** Playwright (`@playwright/test`) — `npx playwright test` runs 412 structural tests (mocked API); `npm run test:smoke` runs 5 live-API smoke tests. See `TESTING.md`.
