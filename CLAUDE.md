...
- **Testing:** Playwright (`@playwright/test`) — `npx playwright test` runs 260 structural tests (mocked API); `npm run test:smoke` runs 5 live-API smoke tests. See `TESTING.md`.
...
- Remaining on committee.html: Raised tab ✅ live (donut, choropleth, individual + committee donor tables, dynamic cycle headers); Spent tab still stub; filing history
