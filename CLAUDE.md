...
- Race context sentence (`.tag-context` pill sourced from `/elections/`, skeleton while loading) lives in `#race-context-bar`, the bottom-most child of `#summary-strip` (T21 follow-up, 2026-05-07) — visible on all tabs as part of the header zone above the tabs bar
