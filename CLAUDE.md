...
- **Testing:** Playwright (`@playwright/test`) — `npx playwright test` runs 524 structural tests (mocked API); `npm run test:smoke` runs 5 live-API smoke tests against `https://fecledgerapp.pages.dev`. See `TESTING.md`.
