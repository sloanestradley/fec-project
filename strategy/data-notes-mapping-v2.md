...
|---|---|---|---|---|---|---|---|
| 1 | ✓ | *"Total receipts ÷ total disbursements"* | Raised:Spent Ratio stat-card label (TOOLTIP-LABEL) | candidate | definitional / contextual | C4.d | **Shipped 2026-06-01** (absolute trigger, top-right of card). |
